...
namespace opt.Provider.Xml
{
    /// <summary>
    /// XML file-based <see cref="Model"/> provider.
    /// </summary>
    public sealed class XmlModelProvider : IModelProvider
    {
        /// <summary>
        /// XML namespace to be used in model XML files.
        /// </summary>
        ...
        /// </summary>
        private readonly XmlReaderSettings modelFileReaderSettings = new XmlReaderSettings
        {
            CloseInput = true,
        ...
        /// <summary>
        /// Reads <see cref="Model"/> from an XML file.
        /// </summary>
        ...
        /// <summary>
        /// Writes <paramref name="model"/> to an XML file.
        /// </summary>
        /// <param name="model"><see cref="Model"/> instance to be written to an XML file.</param>
        /// <param name="filePath">Full path to target model XML file.</param>
        ...
        private static XElement ReadCollectionElement(XName collectionElementName, XElement parentElement, bool throwIfMissing = true)
        {
            ...
            {
                throw new InvalidDataException("Missing " + collectionElementName + " element");
            }
